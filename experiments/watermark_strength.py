...
logging.basicConfig(
    filename='/remote-home/miintern1/watermark-learnability/logs/aronson_watermark_strength_log.txt',  # Specify the log file name
...
num_samples = 512
batch_size = 16
save_path = '/remote-home/miintern1/watermark-learnability/data/c4/aronson_watermark_strength.json'
...
for watermark_name, watermark_config in watermark_configs.items():
    ...
    for i,coefficient in enumerate(coefficient_list):
        ...
        vanilla_model_copy = copy.deepcopy(vanilla_model)
        vanilla_model_copy.to('cpu')
        coefficient_watermarked_model = task_vector.apply_to(vanilla_model_copy, scaling_coef = coefficient)
        ...
        if watermark_config["type"] == "kgw":
            ...
            # print("Using AAR watermark detector")
