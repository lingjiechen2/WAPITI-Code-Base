...
for watermark_name, watermark_config in watermark_config.items():
    ...
    torch.save(watermark_outputs_dict, final_result_folder + "tl_watermark_residuals_2.pt")
    torch.save(watermark_logits_dict, final_result_folder + "tl_watermark_logits_2.pt")
