...
if [ "$dataset_location" = "hf" ]; then
    ...
    dataset_args="--train_file /remote-home1/miintern1/watermark-learnability/experiments/aar_math_input.json"
else
...
torchrun --nproc_per_node=2 --master_port=29544  train_sampling_distill_math.py \
